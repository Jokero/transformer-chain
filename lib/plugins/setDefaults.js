    ...
    _.forOwn(config, function(propertyConfig, propertyName) {
        if (propertyConfig instanceof Object) {
            ...
            if (propertyConfig.properties instanceof Object && objectWithDefaults[propertyName] instanceof Object) {
                var setDefaultsResult = setDefaults(objectWithDefaults[propertyName], propertyConfig.properties);

                if (objectWithDefaults[propertyName] instanceof Array) {
                    objectWithDefaults[propertyName] = _.values(setDefaultsResult);
                } else {
                    objectWithDefaults[propertyName] = setDefaultsResult;
                }
